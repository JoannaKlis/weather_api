...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE: {
        ...
        // Ustawiamy domy lnie wybrany pierwszy przycisk radiowy
    ...
    case WM_COMMAND: {
        if (LOWORD(wParam) == IDC_WEATHER_BUTTON) {
            try {
                ...
                Klasa klasa;
                std::string apiKey = "5f3747f4cc204dfa945172903241605"; // Podaj sw j klucz API
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    HICON hIcon = (HICON)LoadImageW(NULL, L"P:\\proj\\TestVS\\TestVS\\app_icon.ico", IMAGE_ICON, 0, 0, LR_LOADFROMFILE);
    if (hIcon) {
